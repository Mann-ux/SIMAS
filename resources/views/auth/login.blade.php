                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                ...
                                <input id="login" type="text" name="login" value="{{ old('login') }}" required autofocus
                                    autocomplete="username" placeholder="nis/name@sman1kembang.sch.id" class="block w-full pl-11 pr-4 py-3.5
                                               bg-surface-container-low
                                               rounded-xl
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                ...
                                <input id="password" type="password" name="password" required
                                    autocomplete="current-password" placeholder="••••••••" class="block w-full pl-11 pr-12 py-3.5
                                               bg-surface-container-low
                                               rounded-xl
                                               focus:outline-none focus:ring-2 focus:ring-primary/20
                                               text-on-surface placeholder-outline/50
                        ...
                        <div class="flex items-center py-1">
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <input id="remember_me" type="checkbox" name="remember" class="h-5 w-5 rounded
                                               bg-surface-container-low text-primary
                                               focus:ring-primary/20
                                               transition-all">
                                <span
                                    class="text-xs font-medium text-on-surface-variant group-hover:text-primary transition-colors">
                                    Remember this device
                                </span>
                            </label>
                        </div>
