...
<head>
    ...
    <title>@yield('title', 'Dashboard Sekretaris') - SIMAS</title>
        ...
        <aside class="w-64 bg-gradient-to-b from-cyan-800 to-blue-900 text-white flex-shrink-0 hidden md:flex md:flex-col">
            ...
            <div class="p-6 border-b border-cyan-700">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-cyan-300">Sekretaris</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-4 bg-cyan-800/50">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-cyan-300">Sekretaris Kelas</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('sekretaris.dashboard') }}"
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('sekretaris.dashboard') ? 'bg-cyan-600 text-white' : 'text-cyan-200 hover:bg-cyan-700 hover:text-white' }}">
                ...
                <a href="{{ route('sekretaris.absen.create') }}"
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('sekretaris.absen.*') ? 'bg-cyan-600 text-white' : 'text-cyan-200 hover:bg-cyan-700 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Rekap Bulanan -->
                <a href="{{ route('sekretaris.recap') }}"
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('sekretaris.recap') ? 'bg-cyan-600 text-white' : 'text-cyan-200 hover:bg-cyan-700 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm z-10">
                <div class="flex items-center justify-between px-6 py-4">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">@yield('page-title', 'Dashboard Sekretaris')</h2>
                        <p class="text-sm text-gray-600">@yield('page-description', 'Selamat datang di panel sekretaris SIMAS')</p>
                    </div>
