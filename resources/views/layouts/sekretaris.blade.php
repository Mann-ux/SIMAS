    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-8">
                {{-- Logo --}}
                <a href="{{ route('pengurus.dashboard') }}" class="flex items-center gap-2 font-manrope text-2xl font-extrabold tracking-tighter text-blue-900" aria-label="SIMAS Home">
