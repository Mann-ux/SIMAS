...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <!-- Form Filter -->
            <form method="GET" action="{{ route('pengurus.recap') }}" class="flex items-end gap-4 flex-wrap flex-1">
                <div>
            ...
            <!-- Tombol Export Excel -->
            <a href="{{ route('pengurus.recap.export', ['month' => $month, 'year' => $year]) }}" class="px-6 py-2 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                <span class="flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
