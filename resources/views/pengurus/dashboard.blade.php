...
<div class="mb-12">
    <div class="bg-amber-50 rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between border-l-8 border-amber-500 shadow-sm gap-4">
        ...
        <a href="{{ route('pengurus.absen.create') }}" class="bg-blue-900 text-white px-6 py-3 rounded-xl font-bold text-sm tracking-wide shadow-md hover:bg-blue-800 transition-all animate-pulse active:scale-95 inline-block text-center flex-shrink-0 whitespace-nowrap">
            INPUT SEKARANG
        </a>
    </div>
</div>
