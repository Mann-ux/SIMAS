                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select 
                            name="wali_kelas_id" 
                            id="wali_kelas_id" 
                            class="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none @error('wali_kelas_id') border-red-500 @enderror appearance-none bg-white"
                            required
                        >
