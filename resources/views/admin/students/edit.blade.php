...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <!-- Card Body -->
        <form action="{{ route('students.update', $student->id) }}" method="POST" class="px-8 py-8">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            class="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 transition-all duration-200 outline-none @error('nisn') border-red-500 @enderror"
