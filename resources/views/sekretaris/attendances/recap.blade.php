...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <!-- Form Filter -->
            <form method="GET" action="{{ route('sekretaris.recap') }}" class="flex items-end gap-4 flex-wrap flex-1">
                <div>
            ...
            <!-- Tombol Export Excel -->
            <a href="{{ route('sekretaris.recap.export', ['month' => $month, 'year' => $year]) }}" class="px-6 py-2 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                <span class="flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="hidden print:block mt-12">
            <div class="flex justify-between items-end">
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600 mb-16">Sekretaris Kelas,</p>
